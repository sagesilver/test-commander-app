  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <form onSubmit={(e) => { e.preventDefault(); onSubmit?.(form); }} className="tc-testcase-form tc-testcase-new space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                value={form.author || (currentUserData?.name || currentUserData?.displayName || currentUserData?.email || '')}
              ...
              >
                ...
                {(() => {
                  ...
                  return me ? <option value={me}>{me}</option> : null;
                })()}
              </select>
            </div>
            <div>
