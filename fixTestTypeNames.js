// Node.js script to fix test type names using Firebase Admin SDK
// Run this locally with: node fixTestTypeNames.js
...
try {
  admin.initializeApp({
    ...
    databaseURL: 'https://test-commander-project.firebaseio.com'
  });
  ...
  console.log('4. Update the databaseURL above with your actual project ID');
  process.exit(1);
}
